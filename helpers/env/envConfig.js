module.exports = {
	...
	IS_ENCRYPT: process.env.IS_ENCRYPT === "true",
	// CORS Configuration
	...
	TRUST_PROXY: process.env.TRUST_PROXY === "true" || process.env.TRUST_PROXY === "1" || Number.parseInt(process.env.TRUST_PROXY) || false,
	// Rate Limiting Configuration
	RATE_LIMIT_ENABLED: process.env.RATE_LIMIT_ENABLED !== "false" && process.env.RATE_LIMIT_ENABLED !== "0", // Default: true (enabled)
	RATE_LIMIT_WINDOW_MS: Number.parseInt(process.env.RATE_LIMIT_WINDOW_MS) || 15 * 60 * 1000, // Default: 15 minutes
	RATE_LIMIT_MAX: Number.parseInt(process.env.RATE_LIMIT_MAX) || 100, // Default: 100 requests per window
	RATE_LIMIT_LOGIN_MAX: Number.parseInt(process.env.RATE_LIMIT_LOGIN_MAX) || 5, // Default: 5 login attempts per window
	...
	EXTERNAL_API_REFRESH_TOKEN: process.env.EXTERNAL_API_REFRESH_TOKEN,
